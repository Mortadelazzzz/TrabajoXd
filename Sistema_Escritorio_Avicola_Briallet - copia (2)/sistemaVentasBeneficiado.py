...
frmSeleccionarTipoTrozadoCambio = False
...
class Inicio(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.frmAlertaTipoTrozadosCambiarEspecie.setHidden(True)
    ...
    def fn_asignarPesos(self):
        ...
        self.ui.btnPrimerColor.setText("Cubeta Cerrada \n {:.2f} (C)".format(pesoPrimeraVariedad))
        pesoSegundaVariedad = float(pesosAsignarCubetas[1])
        self.ui.btnSegundoColor.setText("Cubeta Abierta \n {:.2f} (A)".format(pesoSegundaVariedad))
        pesoTerceraVariedad = float(pesosAsignarCubetas[2])
        self.ui.btnTercerColor.setText("Cubeta Pequeña \n {:.2f} (P)".format(pesoTerceraVariedad))
        pesoCuartaVariedad = float(pesosAsignarCubetas[3])
        self.ui.btnCuartoColor.setText("Cubeta Grande \n {:.2f} (G)".format(pesoCuartaVariedad))
        pesoQuintaVariedad = float(pesosAsignarCubetas[4])
        self.ui.btnQuintoColor.setText("Otros \n {:.2f} (O)".format(pesoQuintaVariedad))
    ...
    def condiciones_base(self):
        return (
            ...
            not frmSeleccionarTipoTrozadoCambio and
    ...
    def condiciones_alertas(self):
        return (
            ...
            not self.ui.frmIngresarCantidadJabas.isVisible() and
            not self.ui.frmAlertaTipoTrozadosDesc.isVisible() and
    ...
    def keyReleaseEvent(self, event):
        ...
        global frmSeleccionarTipoTrozadoCambio
        global frmSeleccionarEspecieEditarPesada
        ...
        if (event.key() == Qt.Key_1) and not self.ui.lwListaClientes.isVisible() and self.condiciones_base() and self.condiciones_alertas():
            self.fn_seleccionarEspecie(cuartaEspecie) #cuartaEspecie
            ...
            self.fn_seleccionarEspecie(segundaEspecie) #segundaEspecie
            ...
            self.fn_seleccionarEspecie(sextaEspecie) #decimaSextaEspecie
        ...
        if (event.key() == Qt.Key_3) and not self.ui.lwListaClientes.isVisible() and self.ui.frmAplicarDescuento.isVisible() and frmRegistrarDescuento == True and frmRegistrarDescuentoCan == False and frmSeleccionarTipoTrozadoDesc == False:
            ...
            #     self.fn_seleccionarEspecieDescuento(idEspecieDesc)
            #     self.fn_alerta("¡ADVERTENCIA!",error,"No puede seleccionar la especie {} porque la cantidad es 0.".format(nombreSegundaEspecie),1500)
        elif (event.key() == Qt.Key_1) and not self.ui.lwListaClientes.isVisible() and self.ui.frmAplicarDescuento.isVisible() and frmRegistrarDescuento == True and frmRegistrarDescuentoCan == False and frmSeleccionarTipoTrozadoDesc == False:
            ...
            self.fn_seleccionarEspecieDescuento(decimaEspecie)
            self.ui.btnDescPolloTrozado.setText("{} \n {} (9)".format(nombreNovenaEspecie,nombreDecimaEspecie))
        elif (event.key() == Qt.Key_F1) and not self.ui.lwListaClientes.isVisible() and self.ui.frmAplicarDescuento.isVisible() and frmRegistrarDescuento == True and frmRegistrarDescuentoCan == False and frmSeleccionarTipoTrozadoDesc == False:
            if int(self.ui.txtCantPolloXx.text().split()[0].strip()) > 0 :
                self.fn_seleccionarEspecieDescuento(decimaSextaEspecie)
            else:
                idEspecieDesc = 0
                self.fn_seleccionarEspecieDescuento(idEspecieDesc)
        ...
        if (event.key() == Qt.Key_1) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(cuartaEspecie)
        if (event.key() == Qt.Key_2) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(decimaOctavaEspecie)
        if (event.key() == Qt.Key_3) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(segundaEspecie)
        if (event.key() == Qt.Key_4) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(decimaSeptimaEspecie)
        if (event.key() == Qt.Key_5) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(quintaEspecie)
        if (event.key() == Qt.Key_6) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(sextaEspecie)
        if (event.key() == Qt.Key_7) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(septimaEspecie)
        if (event.key() == Qt.Key_8) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(octavaEspecie)
        if (event.key() == Qt.Key_9) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(decimaEspecie)
        if (event.key() == Qt.Key_F1) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == False:
            self.fn_seleccionarEspecieCambiar(decimaSextaEspecie)
        
        if (event.key() == Qt.Key_1) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaEspecie)   
        if (event.key() == Qt.Key_2) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaPrimeraEspecie)
        if (event.key() == Qt.Key_3) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaSegundaEspecie)
        if (event.key() == Qt.Key_4) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaTerceraEspecie)
        if (event.key() == Qt.Key_5) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaCuartaEspecie)
        if (event.key() == Qt.Key_6) and not self.ui.lwListaClientes.isVisible() and self.ui.frmCambiarEspecie.isVisible() and frmSeleccionarEspecieEditarPesada == True and frmIngresarNumeroPesadaEliminar == False and frmSeleccionarTipoTrozadoCambio == True:
            self.fn_seleccionarEspecieCambiar(decimaQuintaOtrasEspecies)
    ...
    # ============= Eventos con la otra función pasada =============
        ...
        if (event.key() == Qt.Key_Enter or event.key() == Qt.Key_Return) and frmRegistrarDescuento == False and frmRegistrarDescuentoCan == True and frmInicioProceso == True and self.ui.frmAplicarDescuento.isVisible() and self.ui.txtCantidadDescuento.text() != "":
            if idEspecieDesc == segundaEspecie and int(self.ui.txtCantYugoPelado.text().split()[0].strip()) < int(self.ui.txtCantidadDescuento.text()):
        ...
        if (event.key() == Qt.Key_Enter or event.key() == Qt.Key_Return) and frmInicioProceso == True and frmIngresarNumeroPesadaEditar == True and not self.ui.lwListaClientes.isVisible() and self.ui.txtNumeroDePesada.text()  != "" and int(self.ui.txtNumeroDePesada.text()) > 0 :                
                ...
                if numeroDePesada <= totalFilas:
                    ...
                    item = self.ui.tblDetallePesadas.item(txtNumeroDePesada, 4)  # Obtener el item de la primera fila y columna 5
                    valor = item.text()
        ...
        if (event.key() == Qt.Key_Enter or event.key() == Qt.Key_Return) and frmInicioProceso == True and frmIngresarNumeroColoresEditar == True and not self.ui.lwListaClientes.isVisible() and self.ui.txtNumeroDePesada.text()  != "" and int(self.ui.txtNumeroDePesada.text()) > 0 :
            ...
            if numeroDePesada <= totalFilas:
                ...
                if identificador == "tb_pesadas":
                    ...
                    datosColoresEditar = self.conexion.db_consultarVariedadEditar2(idPesadaEditarOEliminar)
        ...
        if (event.key() == Qt.Key_Enter or event.key() == Qt.Key_Return) and frmSeleccionarEspecieEditarPesada == True and frmSeleccionarTipoTrozadoCambio == False and frmIngresarNumeroPesadaEditarEspecie == False and frmInicioProceso == True and self.ui.frmCambiarEspecie.isVisible() and idEspecieCambiarEspecie != 0:
            self.ui.frmCambiarEspecie.setHidden(True)
            self.fn_editarEspeciePesada()
            frmSeleccionarEspecieEditarPesada = False
        if (event.key() == Qt.Key_Enter or event.key() == Qt.Key_Return) and frmSeleccionarEspecieEditarPesada == True and frmSeleccionarTipoTrozadoCambio == True and frmIngresarNumeroPesadaEditarEspecie == False and frmInicioProceso == True and self.ui.frmCambiarEspecie.isVisible() and idEspecieCambiarEspecie != 0:
            self.ui.frmAlertaTipoTrozadosCambiarEspecie.setHidden(True)
            frmSeleccionarTipoTrozadoCambio = False
    ...
    def fn_declaraEspecie(self):
        ...
        self.ui.btnTecnicoPelado.setText("{} (1)".format(nombreCuartaEspecie))
        self.ui.btnBrasaTecnico.setText("{} (2)".format(nombreDecimaOctavaEspecie))
        self.ui.btnYugoPelado.setText("{} (3)".format(nombreSegundaEspecie))
        self.ui.btnBrasaYugo.setText("{} (4)".format(nombreDecimaSeptimaEspecie))
        self.ui.btnGallinaDoble.setText("{} (5)".format(nombreQuintaEspecie))
        self.ui.btnGallo.setText("{} (6)".format(nombreSeptimaEspecie))
        self.ui.btnPolloMaltratado.setText("{} (7)".format(nombreOctavaEspecie))
        self.ui.btnPolloXx.setText("{} (8)".format(nombreDecimaSextaEspecie))
        self.ui.btnPolloTrozado.setText("{} (9) \n {}".format(nombreNovenaEspecie,nombreDecimaEspecie))
        self.ui.btnAhogados.setText("{} (F1)".format(nombreSextaEspecie))
        self.ui.btnSecos.setText("{} (F2)".format(nombreVigesimaPrimeraEspecie))
        
        self.ui.btnDescTecnicoPelado.setText("{} (1)".format(nombreCuartaEspecie))
        self.ui.btnDescPolloBrasaTecnico.setText("{} (2)".format(nombreDecimaOctavaEspecie))
        self.ui.btnDescYugoPelado.setText("{} (3)".format(nombreSegundaEspecie))
        self.ui.btnDescBrasaYugo.setText("{} (4)".format(nombreDecimaSeptimaEspecie))
        txtnombreQuintaEspecie = self.format_species_name(nombreQuintaEspecie)
        self.ui.btnDescGallinaDoble.setText("{} (5)".format(txtnombreQuintaEspecie))
        ...
        txtnombreOctavaEspecie = self.format_species_name1(nombreOctavaEspecie)
        self.ui.btnDescPolloMaltratado.setText("{} (8)".format(txtnombreOctavaEspecie))
        self.ui.btnDescPolloTrozado.setText("{} \n {} (9)".format(nombreNovenaEspecie, nombresEspecies[9][1]))
        txtnombreDecimaSextaEspecie = self.format_species_name(nombreDecimaSextaEspecie)
        self.ui.btnDescPolloXx.setText("{} (F1)".format(txtnombreDecimaSextaEspecie))
    ...
    def fn_seleccionarEspecie(self,especie):
        ...
        if especie == 2:
            ...
            precioCliente = precioDecimaSextaEspecie
            idEspecie = decimaSextaEspecie
        elif especie == 17:
    ...
    def fn_seleccionarEspecieDescuento(self,especieDesc):
        ...
        if especieDesc == 2:
            ...
            precioClienteDesc = precioDecimaSextaEspecie
            idEspecieDesc = decimaSextaEspecie
        elif especieDesc == 17:
    ...
    def fn_registrarPesada(self):
        ...
        try:
            ...
            pesoNeto = 0.0  # Por ejemplo, asignando 0.0 como valor por defecto
            cantidadRegistro = 0  # También puedes asignar 0 como valor por defecto
    ...
    def fn_actualizarPesadaColores(self):
        ...
        if (identificador == 'tb_pesadas'):
            respuesta = self.conexion.db_actualizarPesadaVariedad(idPesadaEditarOEliminar,numeroCubetasPes,tipoCubetas,pesoNetoJabas)
            if respuesta == "ERROR" :
            ...
            respuesta = self.conexion.db_actualizarPesadaVariedad2(idPesadaEditarOEliminar,numeroCubetasPes,tipoCubetas,pesoNetoJabas)
            if respuesta == "ERROR" :
                self.fn_alerta("¡ERROR AL EDITAR!",error,"Error al editar la pesada de la otra pc.",2000)
            else:
                self.fn_alerta("¡EDITADO EXITOSO!",correcto,"El registro se edito correctamente.",1500)
    ...
    def fn_seleccionarEspecieCambiar(self,especieCambiar):
        ...
        self.ui.btnCambioYugoPelado.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnCambioTecnicaPelado.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        ...
        self.ui.btnCambioPolloTrozado.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        ...
        self.ui.btnPechugaCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnPiernaCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnAlasCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnMenudenciaCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnDorsoCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        self.ui.btnOtrosCambio.setStyleSheet("background-color: #FFF; color: #000; border: 2px solid black; border-radius: 15px;")
        
        if especieCambiar == 10 or especieCambiar == 11 or especieCambiar == 12 or especieCambiar == 13 or especieCambiar == 14 or especieCambiar == 15:
            self.ui.btnCambioPolloTrozado.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            self.ui.frmAlertaTipoTrozadosCambiarEspecie.setHidden(False)
            frmSeleccionarTipoTrozadoCambio = True
        
        if especieCambiar == 2:
            self.ui.btnCambioYugoPelado.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioSegundaEspecie
            idEspecieCambiarEspecie = segundaEspecie
        elif especieCambiar == 4:
            self.ui.btnCambioTecnicaPelado.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioCuartaEspecie
            idEspecieCambiarEspecie = cuartaEspecie
        elif especieCambiar == 5:
            self.ui.btnCambioGallinaDoble.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioQuintaEspecie
            idEspecieCambiarEspecie = quintaEspecie
        elif especieCambiar == 6:
            self.ui.btnCambioGallinaChica.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioSextaEspecie
            idEspecieCambiarEspecie = sextaEspecie
        elif especieCambiar == 7:
            self.ui.btnCambioGallo.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioSeptimaEspecie
            idEspecieCambiarEspecie = septimaEspecie
        elif especieCambiar == 8:
            ...
            precioCambiarEspecie = precioOctavaEspecie
            idEspecieCambiarEspecie = octavaEspecie
        elif especieCambiar == 16:
            self.ui.btnCambioPolloXx.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaSextaEspecie
            idEspecieCambiarEspecie = decimaSextaEspecie
        ...
        elif especieCambiar == 10:
            self.ui.btnPechugaCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaEspecie
            idEspecieCambiarEspecie = decimaEspecie
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaEspecie))
        elif especieCambiar == 11:
            self.ui.btnPiernaCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaPrimeraEspecie
            idEspecieCambiarEspecie = decimaPrimeraEspecie
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaPrimeraEspecie))
        elif especieCambiar == 12:
            self.ui.btnAlasCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaSegundaEspecie
            idEspecieCambiarEspecie = decimaSegundaEspecie
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaSegundaEspecie))
        elif especieCambiar == 13:
            self.ui.btnMenudenciaCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaTerceraEspecie
            idEspecieCambiarEspecie = decimaTerceraEspecie
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaTerceraEspecie))
        elif especieCambiar == 14:
            self.ui.btnDorsoCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaCuartaEspecie
            idEspecieCambiarEspecie = decimaCuartaEspecie
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaCuartaEspecie))
        elif especieCambiar == 15:
            self.ui.btnOtrosCambio.setStyleSheet("background-color: #2ABF4E; color: #fff; border: 2px solid black; border-radius: 15px;")
            precioCambiarEspecie = precioDecimaQuintaOtrasEspecies
            idEspecieCambiarEspecie = decimaQuintaOtrasEspecies
            self.ui.btnCambioPolloTrozado.setText("POLLO TROZADO \n {} (9)".format(nombreDecimaQuintaOtrasEspecies))
